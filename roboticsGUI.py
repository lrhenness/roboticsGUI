...
def open_window():
    ...
    grid = [
           ...
           [sg.B('*', size=(5, 2), key=(0,10), pad=((1,0),(0,0))),sg.B('*', size=(5, 2), key=(1,10), pad=((0,0),(0,0))),sg.B('*', size=(5, 2), key=(2,10), pad=((0,1),(0,0))),sg.B('*', size=(5, 2), key=(3,10), pad=((0,0),(0,0))),sg.B('*', size=(5, 2), key=(4,10), pad=((0,0),(0,0))),sg.B('*', size=(5, 2), key=(5,10), pad=((0,1),(0,0))),sg.B('*', size=(5, 2), key=(6,10), pad=((0,0),(0,0))),sg.B('*', size=(5, 2), key=(7,10), pad=((0,0),(0,0))),sg.B('*', size=(5, 2), key=(8,10), pad=((0,1),(0,0))),sg.B('*', size=(5, 2), key=(9,10), pad=((0,0),(0,0))),sg.B('*', size=(5, 2), key=(10,10), pad=((0,0),(0,0))),sg.B('*', size=(5, 2), key=(11,10), pad=((0,1),(0,0))),sg.B('*', size=(5, 2), key=(12,10), pad=((0,0),(0,0))),sg.B('*', size=(5, 2), key=(13,10), pad=((0,0),(0,0))),sg.B('*', size=(5, 2), key=(14,10), pad=((0,1),(0,0)))],
