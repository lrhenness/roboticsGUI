...
def open_window():
    ...
    layout_grid = [
        [sg.B('*', size=(3, 1), key=(0,24), pad=((1,0),(1,0))),sg.B('*', size=(3, 1), key=(1,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(2,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(3,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(4,24), pad=((0,1),(1,0))),sg.B('*', size=(3, 1), key=(5,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(6,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(7,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(8,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(9,24), pad=((0,1),(1,0))),sg.B('*', size=(3, 1), key=(10,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(11,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(12,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(13,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(14,24), pad=((0,1),(1,0))),sg.B('*', size=(3, 1), key=(15,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(16,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(17,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(18,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(19,24), pad=((0,1),(1,0))),sg.B('*', size=(3, 1), key=(20,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(21,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(22,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(23,24), pad=((0,0),(1,0))),sg.B('*', size=(3, 1), key=(24,24), pad=((0,1),(0,0)))],
...
def main():
    layout_mysql = [
        ...
        [sg.Input(size=(10,1), pad=((1,1),(1,1)), focus=True, default_text='localhost', key='-hostname-'), sg.Text('Hostname')],
        [sg.Input(size=(10,1), pad=((1,1),(1,1)), key='-username-'), sg.Text('Username')],
        [sg.Input(size=(10,1), pad=((1,1),(1,1)), password_char = '*', key='-password-'), sg.Text('Password')],
        [sg.Input(size=(10,1), pad=((1,1),(1,1)), key='-database-'), sg.Text('Database')],
        [sg.Button("Connect to MySQL", size=(15,2), pad=((10,10),(15,15)), key="connect"), sg.Button("Debug Fill", size=(15,2), pad=((10,10),(15,15)), key="fill")],
        [sg.Text('')],
