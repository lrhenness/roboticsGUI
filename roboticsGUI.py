...
def open_window():
    grid = [[sg.Button('yo', size=(4, 2), key=(x0,0), pad=(0,0)) for x0 in range(15)],
            ...
            [sg.Button('yo', size=(4, 2), key=(x4,4), pad=(0,0)) for x4 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x5,5), pad=(0,0)) for x5 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x6,6), pad=(0,0)) for x6 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x7,7), pad=(0,0)) for x7 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x8,8), pad=(0,0)) for x8 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x9,9), pad=(0,0)) for x9 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x10,10), pad=(0,0)) for x10 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x11,11), pad=(0,0)) for x11 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x12,12), pad=(0,0)) for x12 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x13,13), pad=(0,0)) for x13 in range(15)],
            [sg.Button('yo', size=(4, 2), key=(x14,14), pad=(0,0)) for x14 in range(15)]]
