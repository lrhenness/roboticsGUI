...
def main():
    layout_mysql = [
        ...
        [sg.Button("Connect to MySQL", size=(25,2), pad=((10,10),(15,15)), key="connect")],
        [sg.Button("Debug Fill", size=(10,1), pad=((15,1),(5,5)), key="fill"), sg.Button("Without MySQL", size=(15,1), pad=((1,10),(5,5)), key="open")],
        [sg.Text('')],
