...
def open_window():
    ...
    options = [[sg.Input(size=(5,1), key='-r1_v-'), sg.Text('Velocity for Robot 1 in meters/second', size=(35,1))],
               ...
               [sg.CalendarButton('Datez', size=(20,1), key='-start_date-'), sg.Text('Date for movement', size=(20,1))],
               [sg.Input(size=(5,1), key='-start_time-'), sg.Text('Time for movement: HH:MM:SS', size=(35,1))],
